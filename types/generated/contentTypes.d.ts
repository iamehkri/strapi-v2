...
export interface ApiAiAgentAiAgent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    agentAvatar: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    agentBlurb: Schema.Attribute.Text;
    agentBlurb2: Schema.Attribute.Text;
    agentBlurb3: Schema.Attribute.Text;
    agentName: Schema.Attribute.String;
    agentSegment: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCareerCareer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    roleOverview: Schema.Attribute.RichText;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiPressPress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pressTitle: Schema.Attribute.String;
    pubDate: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSubfeatureSubfeature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subFeatureDescription: Schema.Attribute.RichText;
    subFeatureExcerpt: Schema.Attribute.Text;
    subFeatureIcon: Schema.Attribute.Text &
      Schema.Attribute.CustomField<
        'plugin::icons-field.icon',
        {
          output: 'svg';
      ...
      >;
    subFeaturetitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    teamid: Schema.Attribute.UID<'name'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
